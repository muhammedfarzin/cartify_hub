class DummyData {
  static List<Product> topListingList = [
    Product(
      imageUrl: 'https://m.media-amazon.com/images/I/41-0KwfgelL.jpg',
      title:
    ...
    Product(
        ...
        title: 'Apple iPhone 14 Pro Max 512 GB (Deep Purple, 6 GB RAM)',
        description:
    ...
    Product(
      ...
      title: 'realme Smart TV Full HD 80cm 32',
      description:
    ...
    Product(
      imageUrl:
          'https://m.media-amazon.com/images/I/51YOeZehIKL._AC_UF1000,1000_QL80_.jpg',
      title:
